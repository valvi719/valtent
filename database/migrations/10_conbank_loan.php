...
return new class extends Migration
{
    ...
    {
        Schema::create('conbank_loan', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('interst', 8, 4); // Note the typo in your request, assuming 'interest'
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('conbank_loan');
    }
};